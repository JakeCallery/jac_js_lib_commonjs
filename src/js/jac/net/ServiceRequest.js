define(function(require, exports, module){
  ...
  var EventUtils = require('jac/utils/EventUtils');
  var NetUtils = require('jac/utils/NetUtils');
  var ServReqEvent = require('jac/net/events/ServReqEvent');
  var ServReqProgressEvent = require('jac/net/events/ServReqProgressEvent');
  var ServReqErrorEvent = require('jac/net/events/ServReqErrorEvent');
